...
export default function About() {
  ...
  return (
    <motion.section
      ref={ref}
      className='relative flex flex-col gap-4 px-4 items-center text-center bg-transparent max-w-[45rem] mx-auto scroll-mt-44 text-gray-700 dark:text-white'
